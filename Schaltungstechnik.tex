...
\begin{multicols*}{4}
    ...
    \begin{tabular}{@{}p{1.1cm}p{2.9cm}l}
        ...
        \parbox{1.3cm}{ \shortstack{Konkaver\\Widerstand}   \\ \includegraphics{./img/symb/symb_resistor_concave.png} }& $i=\begin{cases}0&\text{, }u\le U\\ G(u-U)&\text{, }u>U\end{cases}$ & \parbox{1.8cm}{\includegraphics[width=1.8cm]{./img/char/char_resistor_concave.png} } \\ \mrule
        \parbox{1.3cm}{ \shortstack{Konvexer\\Widerstand}   \\ \includegraphics{./img/symb/symb_resistor_convex.png} }& \shortstack{ \shortstack{Dual zum\\\textbf{konkaven Widerstand}} \\ $u=\begin{cases}0&\text{, }i\le I\\ R(i-I)&\text{, }i>I\end{cases}$ }& \parbox{1.8cm}{\includegraphics[width=1.6cm]{./img/char/char_resistor_convex.png} } \\ \mrule
        ...
        \parbox{1.3cm}{ Photodiode   \\ \includegraphics{./img/symb/symb_diode_photo.pdf} }& $i = I_{S} \left( e^{\frac{u_{D}}{U_{T}}} -1 \right) - i_L$ & \parbox{1.8cm}{\includegraphics{./img/char/char_diode_photo.pdf} } \\ \mrule
        \parbox{1.3cm}{ Zenerdiode   \\ \includegraphics{./img/symb/symb_diode_zener3.png} }&\shortstack{ Durchbruch bei $u=U_Z$:\\ für $u\leq U_z$ stark leitend} & \parbox{1.8cm}{\includegraphics[width=1.8cm]{./img/char/char_diode_zener.png} } \\ \mrule
        \parbox{1.3cm}{ Tunneldiode   \\ \includegraphics{./img/symb/symb_diode_tunnel2.png} }& \shortstack{Im gewissen Bereich wie ein\\\textbf{negativer Widerstand}} & \parbox{1.8cm}{\includegraphics[width=1.7cm]{./img/char/char_diode_tunnel.png} }
    \end{tabular}
    ...
    \begin{tabular}{@{}ll}
        ...
        \parbox{3cm}{Hybrid: $h_{ges}=h_{\mathcal F1}+h_{\mathcal F2}$             \\ linear: $\ma H_{\ir ges} = \ma H_1 + \ma H_2$ \\ auch genannt: Serien-Parallel} & \parbox{2.5cm}{\includegraphics{./img/ztv_hybrid.pdf}}\\[2em]
        \parbox{3.5cm}{Hybrid Inv.: $h'_{ges}=h_{\mathcal F1}+h'_{\mathcal F2}$    \\ linear: $\ma H'_{\ir ges} = \ma H'_1 + \ma H'_2$ \\ auch genannt: Parellel-Serie} & \parbox{2.5cm}{\includegraphics{./img/ztv_hybrid_inv.pdf}}\\[2em]
    ...
    \sectionbox{
        ...
        \begin{tabular}{lll}
            \parbox{3cm}{\textbf{\large ESB I}   \\ negativer Sättigungsbereich \\ $u_{\ir d} < 0$  \\ $u_{\ir out} = - U_{\ir sat}$} & \parbox{3cm}{\includegraphics[scale = 0.9]{./img/opamp_esb_1.pdf} }\\[4em]
            ...
            \parbox{3cm}{\textbf{\large ESB III} \\ positiver Sättigungsbereich \\ $u_{\ir d} > 0$  \\ $u_{\ir out} = + U_{\ir sat}$} & \parbox{3cm}{\includegraphics[scale = 0.9]{./img/opamp_esb_3.pdf} }
        \end{tabular}
    }
    ...
    Graphisch: Falls keine geschlossenen Schleifen in q/u, $\Phi$/i-Diagramm existiert (Hysteresefrei)\\
        ...
        \emphbox{
            \begin{tabular}{ll}
                ...
                \textbf{Zeiger}       & \parbox{3cm}{\begin{align*}
                        A & = \alpha + j\beta = A_m \cdot e^{j\phi} \\
