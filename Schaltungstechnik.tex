...
\sectionbox{
	...
	Knoteninzidenzmatrix: $\ma A = \mat{\alpha_{11} &  \ldots & \alpha_{1b} \\ \vdots & &  \\ \alpha_{n-1,1} & \ldots & \alpha_{n-1,b}}$ $n$ Knoten
	\textbf{Aufstellen}
...
\tablebox{
	...
	\ctrule
		...
		F spannungsgesteuert & $\exists g_F(i)$\\
...
% ===============================================================================================
	...
	\textbf{Magnetischer Fluss \textit{$\Phi$}}: Grundeigenschaft von elektr. magn. Feldern\\
		...
		- Kapazitiv: $W_C = \frac{1}{2C}u^2 = \frac{1}{2C}q^2$\\
		- Induktiv: $W_L = \frac{1}{2L}i^2 = \frac{1}{2L} \Phi^2$\\
		Graphisch: Fläche zwischen der Kennlinie und der q-/$\Phi$-Achse\\
		\textbf{Relaxationspunkte (=Ruhepunkte)}: Betriebspunkte, in dem die in einer Reaktanz gespeicherte Energie minimal ist. Kandidaten sind: Extremwerte, Wendepunkte, Knicke, Schnittpunkte mit Achsen\\
